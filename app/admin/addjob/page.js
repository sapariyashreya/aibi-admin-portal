...
export default function Page() {
  ...
  try {
    ...
    setErrorMessage(err.message || 'Something went wrong while creating the job.');
  } finally {
...
<div className="bg-white/90 backdrop-blur-sm border border-slate-200 rounded-2xl shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
  ...
  >
    ...
    <div className="pt-4 flex items-center justify-end gap-3">
      ...
      <button
        type="submit"
        className="inline-flex items-center justify-center rounded-xl bg-orange-500 hover:bg-orange-600 text-white text-sm font-medium px-6 py-2.5 shadow-md shadow-orange-500/30 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
